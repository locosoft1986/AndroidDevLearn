package com.locosoft.yon.dialog;
...
public class ColorPickerDialog extends Dialog {
    ...
    private int mInitialColor;  //The format of the color is 0x[alpha][R][G][B]. 0xFF0000FF for blue
    ...
    private class ColorPickerView extends View {
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if(highlightCenter && inCenter) {//If the click action was both started at center and ended at center
        ...
        //Get the selected color in the circle
        ...
        //Get the color in the rectangle blow
     ...
     * @author [url=locosoft1986@gmail.com]LynK[/url]

     * 

     * Create on 2015-1-6 8:21:05am
    ...
    public interface OnColorChangedListener {
         ...
         * @param color The color that the user has choosed
